...
print(f"Output of classic ANN model: {lin(x).shape[1]}")
print(f"Output of convolutional model: {convolutions(x).shape[1]}")
...
# This is the output:
Output of classic ANN model: 512
Output of convolutional model: 512
